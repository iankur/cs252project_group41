...
for a_Tag in BeautifulSoup(response, parseOnlyThese=SoupStrainer('a')).find_all('a', href=True):
	if ('../pages/CS' in a_Tag['href'] or '../pages/ESC' in a_Tag['href']) and not ('CSE' in a_Tag['href']) and(not('CS631' in a_Tag['href']) and not('CS635' in a_Tag['href']) and not('CS638' in a_Tag['href']) and not('CS656' in a_Tag['href']) and not('CS749' in a_Tag['href']) and not('CS750' in a_Tag['href'])):
